...
- [3.2 Profile Setup](./3.2-PROFILE-SETUP.md)
- [3.4 Communities](./3.4-COMMUNITIES.md) — mutual community connections
- [3.5 Drops](./3.5-DROPS.md)
- [Business Rules](../4-BUSINESS-RULES.md)
- [Data Model](../5-DATA-MODEL.md)
