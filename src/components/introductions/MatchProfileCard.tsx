...
export const MatchProfileCard: React.FC<MatchProfileCardProps> = ({ profile, onSayHi, onSave }) => {
  return (
    <View className="w-40">
      ...
      {/* Match description */}
      {/* <Text className="mt-2 text-xs leading-4 text-slate-500" numberOfLines={2}>
